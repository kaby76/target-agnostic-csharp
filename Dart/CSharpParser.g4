...
options { superClass = CSharpParserBase; tokenVocab=CSharpLexer; }

@header{
import 'CSharpParserBase.dart';
}
...
right_arrow
	: first='=' second='>' { P1() }? // Nothing between the tokens?
	;

right_shift
	: first='>' second='>' { P2() }? // Nothing between the tokens?
	;

right_shift_assignment
	: first='>' second='>=' { P3() }? // Nothing between the tokens?
	;
